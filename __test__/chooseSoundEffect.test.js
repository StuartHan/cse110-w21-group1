...
const { chooseSoundEffect } = require("../source/Front-end/javascript/mainjest.js");

describe("chooseSoundEffect testing", () => {
    test("test case of sound selection is Bell", () => {

        document.getElementById("sound-selection").value = "Bell";

        path = "source/Front-end/css/assets/bellChime.mp3";

        chooseSoundEffect();

        expect(document.getElementById("sound-effect").src).toBe("http://localhost/" + path);
        expect(window.localStorage.getItem("sound-selection")).toBe(path);

    })

    test("test case of sound selection is BigBen", () => {

        document.getElementById("sound-selection").value = "BigBen";

        path = "source/Front-end/css/assets/BigBenBellChime.mp3";
    ...
    test("test case of sound selection is Temple", () => {

        document.getElementById("sound-selection").value = "Temple";

        path = "source/Front-end/css/assets/TempleBell.mp3";
