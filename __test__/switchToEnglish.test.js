...
const { SwitchToEnglish } = require("../source/Front-end/javascript/mainjest.js")


describe("switchToEnglish testing", () => {
    test("test", () => {

        SwitchToEnglish();
        
        // document.getElementById("welcome").innerHTML = "Welcome Guest!";
        expect(document.getElementById("workText").innerHTML).toBe("Work Phase");
        expect(document.getElementById("ShortBreakText").innerHTML).toBe("Short Break");
        expect(document.getElementById("LongBreakText").innerHTML).toBe("Long Break");
        expect(document.getElementById("start-btn").innerHTML).toBe("START");
        expect(document.getElementById("settingsTitle").innerHTML).toBe("Settings");
        expect(document.getElementById("WorkTimeTitle").innerHTML).toBe("Work Phase (min):");
        expect(document.getElementById("ShortBreakTitle").innerHTML).toBe("Short Break (min):");
        expect(document.getElementById("LongBreakTitle").innerHTML).toBe("Long Break (min):");
        expect(document.getElementById("languageTitle").innerHTML).toBe("Language:");
        expect(document.getElementById("LongBreakInterval").innerHTML).toBe("Work Phases in 1 Round:");
        expect(document.getElementById("sound-select").innerHTML).toBe("Ring: ");
        expect(document.getElementById("default-1").innerHTML).toBe("Bell");
        expect(document.getElementById("default-2").innerHTML).toBe("Big Ben");
        expect(document.getElementById("default-3").innerHTML).toBe("Temple (Low Freq)");
        expect(document.getElementById("colorblindtitle").innerHTML).toBe("Color Blind Mode:");
        // Team
        expect(document.getElementById("teamsLabel").innerHTML).toBe("Teams");
        expect(document.getElementById("invite").innerHTML).toBe("Invite");
        expect(document.getElementById("createTeamButton").innerHTML).toBe("Create");
        expect(document.getElementById("teamsAccountLogin").innerHTML).toBe("Login");
        expect(document.getElementById("disableText").innerHTML).toBe("Disable Teams");
        // Create team
        expect(document.getElementById("createTeamTag").innerHTML).toBe("Create Team");
        expect(document.getElementById("backToTeams").innerHTML).toBe("Back");
        expect(document.getElementById("teamName").innerHTML).toBe("Name");
        expect(document.getElementById("workTeam").innerHTML).toBe("Work Time");
        expect(document.getElementById("shortTeam").innerHTML).toBe("Short Break");
        expect(document.getElementById("longTeam").innerHTML).toBe("Long Break");
        expect(document.getElementById("finalizeCreate").innerHTML).toBe("Create");
        // document.getElementById("statistics").innerHTML).toBe("Stats");
        expect(document.getElementById("saveSettings").innerHTML).toBe("Save");
        expect(document.getElementById("statisticsTitle").innerHTML).toBe("Statistics");
        expect(document.getElementById("statsCong").innerHTML).toBe("Congrats! Keep on moving!");
        expect(document.getElementById("OKbtn-statistics").innerHTML).toBe("OK");
        // alertTime = "Please enter an integer between 1 and 120.";
        // alertIntv = "Please enter an integer between 1 and 10.";
        // Doge Shop
        expect(document.getElementById("dogeTitle").innerHTML).toBe("Doge Shop");
        expect(document.getElementById("themeTitle").innerHTML).toBe("Themes");
        expect(document.getElementById("preview").innerHTML).toBe("Click to Preview");
        expect(document.getElementById("select").innerHTML).toBe("Buy/Select");
        expect(document.getElementById("wildjungletitle").innerHTML).toBe("Wild Jungle");
        expect(document.getElementById("junglecost").innerHTML).toBe("Free");
        expect(document.getElementById("nightmodetitle").innerHTML).toBe("Night Mode");
        expect(document.getElementById("nightcost").innerHTML).toBe("Free");
        expect(document.getElementById("aquatictitle").innerHTML).toBe("Aquatic");
        expect(document.getElementById("aquaticcost").innerHTML).toBe("50 Coins");
        expect(document.getElementById("sanfranciscotitle").innerHTML).toBe("San Francisco");
        expect(document.getElementById("sanfranciscocost").innerHTML).toBe("100 Coins");
        expect(document.getElementById("dogelandtitle").innerHTML).toBe("Doge Land");
        expect(document.getElementById("dogecost").innerHTML).toBe("Everything");
        expect(document.getElementById("dogebuy").innerHTML).toBe("Buy");
        expect(document.getElementById("dogeSave").innerHTML).toBe("Close");
        expect(document.getElementById("insufficientText").innerHTML).toBe("Insufficient Funds");
