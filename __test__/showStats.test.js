...
describe("shosStats testing", () => {
    test("when language-form is english", () => {
        ...
        // testing setting
        document.getElementById("language-form").value = "English";
        ...
        // the variable "english" is True
        expect(statsWork.innerHTML).toBe("You have worked " + totalWorkMins + " mins.");
        expect(statsBreak.innerHTML).toBe("And rested " + totalBreakMins + " mins.")

    });

    test("when language-form is chinese", () => {

        // testing setting
        document.getElementById("language-form").value = "Chinese";

        expect(document.getElementById("language-form").value).toBe("Chinese");
        ...
        // the variable "english" is True
        expect(statsWork.innerHTML).toBe("您已工作" + totalWorkMins + "分钟");

        expect(statsBreak.innerHTML).toBe("您已休息" + totalBreakMins + "分钟");
