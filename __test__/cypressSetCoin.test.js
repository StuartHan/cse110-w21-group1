...
const { cypressSetCoin } = require("../source/Front-end/javascript/mainjest.js");


describe("cypressSetCoin testing", () => {

    test("set input = 0", () => {

        cypressSetCoin(0);

        expect(localStorage.getItem("coin")).toBe("0");
    ...
    test("set input = 50", () => {
        ...
        expect(localStorage.getItem("coin")).toBe("50");
        expect(document.getElementById("cointext").innerHTML).toBe("50");
    ...
    test("set input = 200", () => {
        ...
        expect(localStorage.getItem("coin")).toBe("200");
        expect(document.getElementById("cointext").innerHTML).toBe("200");
